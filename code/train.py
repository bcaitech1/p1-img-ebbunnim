...
import torch
from torch.optim.lr_scheduler import StepLR,CosineAnnealingWarmRestarts,CosineAnnealingLR,MultiplicativeLR
...
if __name__ == '__main__':
    ...
    parser.add_argument('--momentum', type=float, default=0.9, help='(추가)momentum')
    parser.add_argument('--val_ratio', type=float, default=0.9, help='ratio for validaton (default: 0.2)')
